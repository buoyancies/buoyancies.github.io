...
* [Teaching in context](#teaching-in-context)
* [Looking beyond the tech](#looking-beyond-the-tech)
* [My own writing](#my-own-writing)

<h2 id="workflows-that-work">Workflows that work</h2>
...
<h2 id="maximising-impact">Maximising impact</h2>
...
<h2 id="teaching-in-context">Teaching in context</h2>
...
> 📖 [Abstractions: No, not like that](https://dev.to/suesmith/abstractions-no-not-like-that-3pl3) _– October 2023_
...
> 📖 [You should have your own domain](https://dev.to/fastly/you-should-have-your-own-domain-23mp) _– December 2023_
...
> 📖 [An easy intro to edge computing](https://dev.to/fastly/an-easy-intro-to-edge-computing-3ced) _– July 2024_

During the era of DevRel, I influenced peers to engage more productively with business dynamics.

> 📖 [Learning as engagement infrastructure](https://dev.to/suesmith/learning-as-engagement-infrastructure-314c) _– March 2021_

<h2 id="my-own-writing">My own writing</h2>
...
_More recently I've been making sense of my own thoughts about AI over on [my blog](https://www.sue.codes)._